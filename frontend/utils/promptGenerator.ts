...
export function generateUnifiedPrompt(config: UnifiedPromptConfig): string {
  ...
  promptParts.push(
    ...
    "## Output Format",
    "",
    "CRITICAL: Your response must contain ONLY valid JSON. Do not include any explanatory text, introductions, code block markers, or any other content. Start your response immediately with the opening '{' character.",
    "",
