...
def print_topic_summary():
    ...
    print(f"Event Retention: 30 days (analytics: 90 days, notifications: 7 days)")
...
if __name__ == "__main__":
    ...
    parser.add_argument("--action", choices=["create", "verify", "delete", "summary"], 
