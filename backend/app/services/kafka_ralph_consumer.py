...
class KafkaRalphConsumer:
    ...
    async def start_consuming(self) -> None:
        ...
        try:
            ...
            await self.kafka.start_consumer(
                topics=self.topics,
                group_id="nlj-ralph-lrs-consumer"
            )
    ...
    async def _convert_to_xapi_statement(
        self, 
        topic: str, 
        event: Dict[str, Any]
    ...
    def _convert_program_event(self, event: Dict[str, Any]) -> Optional[Dict[str, Any]]:
        ...
        return {
            ...
            "actor": {
                ...
                "account": {
                    "name": creator_info.get("id", "unknown"),
    ...
    def _convert_session_event(self, event: Dict[str, Any]) -> Optional[Dict[str, Any]]:
        ...
        return {
            ...
            "actor": {
                ...
                "account": {
                    "name": scheduler_info.get("id", "unknown"),
                    "homePage": "http://nlj.platform"
                }
            },
            "verb": {
    ...
    def _convert_booking_event(self, event: Dict[str, Any]) -> Optional[Dict[str, Any]]:
        ...
        return {
            ...
            "actor": {
                ...
                "account": {
                    "name": learner_info.get("id", "unknown"),
                    "homePage": "http://nlj.platform"
                }
            },
            "verb": {
                "id": verb_id,
                "display": {"en-US": status}
            },
            "object": {
                "objectType": "Activity",
                "id": f"http://nlj.platform/training-sessions/{session_id}",
    ...
    def _convert_activity_event(self, event: Dict[str, Any]) -> Optional[Dict[str, Any]]:
        ...
        return {
            ...
            "object": {
                "objectType": "Activity",
                "id": activity_id,
                "definition": event.get("object", {}).get("definition", {
