...
class ManagePermissionsUseCase(BaseUseCase[ManagePermissionsRequest, ManagePermissionsResponse]):
    ...
    async def _validate_permission_rights(
        self,
        request: ManagePermissionsRequest,
        ...
        if (request.action == PermissionAction.CHANGE_USER_ROLE and 
            request.target_user_id == current_user_id and
    ...
    async def _handle_check_permissions(
        ...
        permission_summary = await permission_orm_service.get_user_permissions(
    ...
    async def _handle_list_permissions(
        ...
        permission_summary = await permission_orm_service.get_permission_summary(
            request.target_user_id
        )
    ...
    async def _handle_get_role_statistics(
        self,
        request: ManagePermissionsRequest
    ) -> dict[str, Any]:
        ...
        return {
            ...
            "user_data": {}  # No specific user data for statistics
        }
    ...
    async def _publish_permission_event(
        self,
        response: ManagePermissionsResponse,
        request: ManagePermissionsRequest,
        user_context: dict[str, Any]
    ) -> None:
