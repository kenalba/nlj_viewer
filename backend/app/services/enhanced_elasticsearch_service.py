...
# Global enhanced Elasticsearch service instance
enhanced_elasticsearch_service = ElasticsearchService()


# Dependency injection functions for FastAPI
async def get_elasticsearch_service() -> ElasticsearchService:
    """Get enhanced Elasticsearch service instance for dependency injection"""
    return enhanced_elasticsearch_service