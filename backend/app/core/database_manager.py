...
class DatabaseConnectionManager:
    ...
    async def _setup_direct_connection(self):
        ...
        try:
            ...
            self.engine = create_async_engine(
                self._connection_url, echo=False, pool_size=10, max_overflow=20  # Disable verbose SQL logging
            )
    ...
    def get_connection_info(self) -> dict:
        ...
        return {"url": self._connection_url, "use_rds": self._use_rds, "engine_initialized": self.engine is not None}
    ...
    async def _ensure_tables(self):
        ...
        try:
            ...
            from app.models.workflow import ApprovalWorkflow, ContentVersion  # noqa: F401
