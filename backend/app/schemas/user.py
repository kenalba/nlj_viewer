...
class UserList(BaseModel):
    ...
    model_config = ConfigDict(
        json_schema_extra={
            "example": {"users": [], "total": 50, "page": 1, "per_page": 20, "has_next": True, "has_prev": False}
        }
    )
...
class LoginRequest(BaseModel):
    ...
    model_config = ConfigDict(json_schema_extra={"example": {"username": "johndoe", "password": "securepassword123"}})
